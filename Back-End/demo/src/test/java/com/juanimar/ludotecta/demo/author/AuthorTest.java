...
import com.juanimar.ludotecta.demo.author.service.AuthorServiceImpl;
...
public class AuthorTest {
    ...
    public void getExistsAuthorIdShouldReturnAuthor() {
        ...
        Author authorResponse = authorService.getAuthorById(EXISTS_AUTHOR_ID);
    ...
    public void getNotExistsAuthorIdShouldReturnNull() {
        ...
        Author author = authorService.getAuthorById(NOT_EXISTS_AUTHOR_ID);
